...
urlpatterns = [
    ...
    path(
        "ver_permisos/mostrar_archivo/<int:id_permiso>/",
        GestionPermisos.as_view(),
        name="mostrar_archivo",
    ),
    path(
        "update_permiso/<int:pk>/", ActualizarPermiso.as_view(), name="update_permiso"
    ),
    ...
    path(
        "timeline_permiso_chart/", timeline_permiso_chart, name="timeline_permiso_chart"
    ),
    path(
        "actualizar_permisos_chart/<str:fecha>/",
        actualizar_permisos_chart,
        name="actualizar_permisos_chart",
    ),
    path(
        "actualizar_permisos_chart_area/<str:area_id>/",
        actualizar_permisos_chart_area,
        name="actualizar_permisos_chart_area",
    ),
    path(
        "actualizar_permisos_chart_dias/<str:fecha>/",
        actualizar_permisos_chart_dias,
        name="actualizar_permisos_chart_dias",
    ),
    path(
        "actualizar_permisos_chart_horas/",
        actualizar_permisos_chart_horas,
        name="actualizar_permisos_chart_horas",
    ),
    path(
        "actualizar_tabla_areas/<str:area_id>/",
        GestionPermisos.actualizar_tabla_areas,
        name="actualizar_tabla_areas",
    ),
    # Licencias
    path("ver_licencias", GestionLicencias.as_view(), name="ver licencias"),
    path(
        "ver_licencias/mostrar_archivo_licencia/<int:id_licencia>/",
        GestionLicencias.as_view(),
        name="mostrar_archivo_licencia",
    ),
    path(
        "update_licencia/<int:pk>/",
        ActualizarLicencia.as_view(),
        name="update_licencia",
    ),
    ...
    path(
        "timeline_licencia_chart/",
        timeline_licencia_chart,
        name="timeline_licencia_chart",
    ),
    path(
        "actualizar_licencias_chart/<str:fecha>/",
        actualizar_licencias_chart,
        name="actualizar_licencias_chart",
    ),
    path(
        "actualizar_licencias_chart_horas/",
        actualizar_licencias_chart_horas,
        name="actualizar_licencias_chart_horas",
    ),
    path(
        "actualizar_licencias_chart_area/<str:area_id>/",
        actualizar_licencias_chart_area,
        name="actualizar_licencias_chart_area",
    ),
    path(
        "actualizar_licencias_chart_dias/<str:fecha>/",
        actualizar_licencias_chart_dias,
        name="actualizar_licencias_chart_dias",
    ),
    path(
        "actualizar_tabla_licencias_areas/<str:area_id>/",
